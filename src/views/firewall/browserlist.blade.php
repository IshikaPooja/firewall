            ...
            <div class="cart-body">
                ...
                <form action="{{route('firewall.browserlist_store')}}" method="post">
                    ...
                    <div class="d-flex mt-4">
                        <div class="col-4">
                            <div class="row">
                                <label  class="col-3">Browser Name</label>
                                <div class="col-8">
                                    <input type="text" name="browser_name" class="form-control" value="{{ old('browser_name') }}">
                                    @error('browser_name')
...
<script>
    ...
    var delete_url = "{{route('firewall.browser_delete')}}";
