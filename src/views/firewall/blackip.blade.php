    ...
    <div class="col-12">
        ...
        <div class="cart">
            <div class="cart-body">
                    ...
                    <form action="{{route('firewall.blacklist_store')}}" method="post">
                        @csrf
                        <div class="d-flex mt-4">
                            <div class="col-4">
                                <div class="row">
                                    <label class="col-3">Black IP  </label>
                                    <div class="col-8">
                                        <input type="text" name="blackip" class="form-control" value="{{ old('blackip') }}">
                                        @error('blackip')
...
<script>
    ...
    var delete_url = "{{route('firewall.blackip_delete')}}";
